...
<body><br><br>
    <div align="center">
        <font size="5"><b>Edit Data</b></font><br><br>
        <form action="edit-proses.php" method="post">
            <table align="center">
                <tr>
                    <td>NIM</td>
                    <td><input type="text" name="id_mahasiswa" value="<?= $data['id_mahasiswa'];?>"></td>
                </tr>
                <tr>
                    <td>Nama</td>
                ...
                <tr>
                    ...
                    <td>
                        <select name="jurusan">
                            <option hidden selected><?php echo $data['jurusan'];?></option>
